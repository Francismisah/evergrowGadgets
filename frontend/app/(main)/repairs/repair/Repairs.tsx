...
const Repairs: React.FC = () => {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    alert(
      "Check console for submitted data. (Backend integration not included)"
    );
  ...
  return (
    <div className="flexCenter md:max-container  lg:max-container  w-full flex-col ">
      <div
        className="max-container mx-auto my-6 flex   flex-col justify-between gap-32 bg-blend-multiply overflow-hidden bg-pattern-3 bg-red-950 bg-opacity-70  bg-cover bg-center bg-no-repeat px-6 py-12 text-white sm:flex-row sm:gap-12 sm:py-24 lg:px-20 xl:max-h-[598px]  xl:rounded-5xl  xl:mx-6 2xl:rounded-5xl;
      ...
      >
        <div className=" flex  flex-1   flex-col flexCenter text-center items-start justify-center gap-12">
          <h2 className="bold-40 lg:bold-64 capitalize  text-center">
            Get Your Laptop, Computer and Hardwares properly{" "}
            <span className="text-yellow-400">Fixed!</span>
          </h2>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6 border-b border-gray-200 pb-6">
            ...
            <p className="text-gray-500 text-sm mt-2">
              Note: please kindly tape a paper on your system that has your
              username and date you gave the system to the dispatch rider and
              serial number given to you for the system.
            </p>
          </div>
