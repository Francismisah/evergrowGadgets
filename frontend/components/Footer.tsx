...
const Footer = () => {
  return (
    <footer className="flexCenter py-11   bg-red-950 bg-center bg-cover ">
      <div
        className="padding-container max-container mb-16 flex w-full
      flex-col gap-14"
      >
        <div className="flex flex-col items-star justify-center gap-[10%] md:flex-row">
          <Link href="/" className="flex items-center justify-center">
            ...
            <div className="flex">
              <h3 className="bold-16 text-red-500">Expose</h3>
              <h3 className="bold-16 text-white">Cancer</h3>
            </div>
          </Link>
          <div className="flex flex-wrap gap-10 sm:justify-between md:flex-1">
              ...
              <FooterColumn title={FOOTER_CONTACT_INFO.title}>
                {FOOTER_CONTACT_INFO.links.map((link) => (
                  ...
                  >
                    ...
                    <p
                      className="medium-14 whitespace-nowrap text-white
                        "
                    >
                      {link.value}:
                    </p>
            ...
            <div className="flex flex-col  gap-5">
              <FooterColumn title={SOCIALS.title}>
                <ul
                  className="regular-14 flex flex-row gap-4 text-white
            "
                >
