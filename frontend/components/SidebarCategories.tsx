...
const SidebarCategories: React.FC<SidebarProps> = ({
  ...
  return (
    <section className="flex flex-row my-12 max-container mx-4 relative">
      ...
      >
        {" "}
        {/* Added min-width and margin-right for better layout */}
        <section className="justify-around py-12">
          <button
            className="bold-20 my-6 text-black flexCenter gap-28 hover:text-red-700"
            onClick={toggleCompress}
          >
            <span className="text">
              {isCompressed ? "Categories" : "Categories"}
            </span>{" "}
            <span className="p-1 rounded-full w-5 bg-gray-20">
              <Image src="/minimize.svg" width={50} height={50} alt={""} />
            </span>
          </button>
          <ul className="gap-4 text-left">
            <li
              className={`bold-16 text-black my-6 flex flex-row gap-2 hover:text-red-700 cursor-pointer ${
                activeContent === "Brand New Laptops"
            ...
            >
              <div className="flexCenter">
                <span>
                  <Image src="/Brand.png" width={60} height={50} alt={""} />
                </span>{" "}
                <span className="text">
                  {isCompressed ? "" : "Brand New Laptops"}
                </span>
              </div>
            </li>
            <li
              className={`bold-16 my-6 text-black flex flex-row gap-2 hover:text-red-700 cursor-pointer ${
                activeContent === "Foreign Used Laptops"
                  ? "font-bold text-green-700"
                  : ""
              }`}
            ...
            >
              <div className="flexCenter">
                <span>
                  <Image src="/used.png" width={60} height={50} alt={""} />
                </span>{" "}
                <span className="text">
                  {isCompressed ? "" : "Foreign Used Laptops"}
                </span>
              </div>
            </li>
            <li
              className={`bold-16 my-6 text-black flex flex-row gap-2 hover:text-red-700 cursor-pointer ${
                activeContent === "Brand New Computers"
                  ? "font-bold text-green-700"
                  : ""
              }`}
            ...
            >
              <div className="flexCenter">
                <span>
                  <Image src="/computer.png" width={60} height={50} alt={""} />
                </span>{" "}
                <span className="text">
                  {isCompressed ? "" : "Brand New Computers"}
                </span>
              </div>
            </li>
            <li
              className={`bold-16 my-6 text-black flex flex-row gap-2 hover:text-red-700 cursor-pointer ${
                activeContent === "Foreign Used Computers"
                  ? "font-bold text-green-700"
                  : ""
              }`}
            ...
            >
              <div className="flexCenter">
                <span>
                  <Image src="/computers.png" width={60} height={50} alt={""} />
                </span>{" "}
                <span className="text">
                  {isCompressed ? "" : "Foreign Used Computers"}
                </span>
              </div>
            </li>
            <li
              className={`bold-18 my-6 text-black flex flex-row gap-2 hover:text-red-700 cursor-pointer ${
                activeContent === "Accessories"
                  ? "font-bold text-green-700"
                  : ""
              }`}
            ...
            >
              <div className="flexCenter gap-2 ml-3">
                <span>
                  <Image src="/plus.svg" width={40} height={30} alt={""} />
                </span>{" "}
      ...
      <section className="absolute -top-20  left-11 ml-2 mb-2  justify-around py-12 md:hidden lg:hidden">
        <button onClick={handleCategorySelection}>
          {categoriesContent ? (
            <div className="bold-20 my-6 text-black flexCenter gap-28 hover:text-red-700">
              {" "}
              <span className="text">Categories</span>{" "}
              <span className="p-1 rounded-full w-5 bg-gray-20">
                <Image src="/minimize.svg" width={20} height={20} alt={""} />
              </span>
            </div>
          ) : (
            <div className="bold-20 my-6 text-black flexCenter gap-28 hover:text-red-700">
        ...
        {categoriesContent && (
          <ul className="gap-4 text-left bg-white">
            <li
              className={`bold-16 text-black my-6 flex flex-row gap-2 hover:text-red-700 cursor-pointer ${
                activeContent === "Brand New Laptops"
                  ? "font-bold text-green-700"
