  ...
  return (
    <div className=" m-4  flexCenter items-left object-left  justify-left flex-col  text-left border-none rounded-lg">
      ...
      <div className="text-left my-2">
        ...
        <div className="flex flex-col flexCenter sm:flex-col lg:flex-row md:flex-row gap-24 my-2">
...
const UsedComputers = () => {
  ...
  const getGridColumns = () => {
    if (windowWidth >= 1280) {
      // xl breakpoint (e.g., 1280px)
      return "repeat(3, minmax(0, 1fr))";
    } else if (windowWidth >= 1024) {
      // lg breakpoint (e.g., 1024px)
      return "repeat(2, minmax(0, 1fr))";
    } else if (windowWidth >= 768) {
      // md breakpoint (e.g., 768px)
      return "repeat(2, minmax(0, 1fr))";
    } else if (windowWidth >= 640) {
      // sm breakpoint (e.g., 640px)
      return "repeat(2, minmax(0, 1fr))";
    } else {
      // default for small screens (e.g., <640px)
